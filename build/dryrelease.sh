...
# Create OUTDIR before doing any work, and make it absolute: the archive is
# written after a cd into the throwaway worktree, where a relative path would
# silently land in the worktree and vanish with it.
mkdir -p "$OUTDIR"
