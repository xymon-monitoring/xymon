...
# BEGIN SHARED fs_mounts-type-keyword (generated by build/mkclientshared.sh from client/shared/fs_mounts-type-keyword.sh; edit there)
fs_mounts() {
	mount | awk '
		{
			i = index($0, " on ")
...
# END SHARED fs_mounts-type-keyword
