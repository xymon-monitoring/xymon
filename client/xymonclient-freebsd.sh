...
# BEGIN SHARED fs_mounts-type-in-parens (generated by build/mkclientshared.sh from client/shared/fs_mounts-type-in-parens.sh; edit there)
fs_mounts() {
	mount | awk '
		{
			i = index($0, " on ")
...
# END SHARED fs_mounts-type-in-parens
...
# BEGIN SHARED fs_procname (generated by build/mkclientshared.sh from client/shared/fs_procname.sh; edit there)
...
# BEGIN SHARED run_df (generated by build/mkclientshared.sh from client/shared/run_df.sh; edit there)
