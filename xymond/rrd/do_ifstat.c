...
int do_ifstat_rrd(char *hostname, char *testname, char *classname, char *pagepaths, char *msg, time_t tstamp)
{
	...
	static pcre_pattern_t **ifstat_linux_pcres = NULL;
	static pcre_pattern_t **ifstat_freebsd_pcres = NULL;
	static pcre_pattern_t **ifstat_freebsdV8_pcres = NULL;
	static pcre_pattern_t **ifstat_openbsd_pcres = NULL;
	static pcre_pattern_t **ifstat_netbsd_pcres = NULL;
	static pcre_pattern_t **ifstat_darwin_pcres = NULL;
	static pcre_pattern_t **ifstat_solaris_pcres = NULL;
	static pcre_pattern_t **ifstat_aix_pcres = NULL;
	static pcre_pattern_t **ifstat_hpux_pcres = NULL;
	static pcre_pattern_t **ifstat_sco_sv_pcres = NULL;
	static pcre_pattern_t **ifstat_bbwin_pcres = NULL;
	...
	void *xmh;
	pcre_pattern_t *ifname_filter_pcre = NULL;
