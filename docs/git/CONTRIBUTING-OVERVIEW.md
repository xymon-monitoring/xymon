...
PURPOSE
-------
This document is the entry point for contributors.
It links to the right document for each topic.


RECOMMENDED READING ORDER
-------------------------
1. [CONTRIBUTING-OVERVIEW.md](CONTRIBUTING-OVERVIEW.md) (this file)
2. [FIRST-CONTRIBUTION.md](FIRST-CONTRIBUTION.md)
3. [git-quick-start.md](git-quick-start.md)
