...
int main(int argc, char **argv)
{
	...
	if (strcmp(mode, "none") == 0) {
		 ...
		 * 7 instances over a maxgraphs of 5 rebalance to two graphs of step 4,
		 * the second holding the remainder (lib/xymonrrd.c) - so the second
		 * page carries count=4 while rendering three files, which showgraph
		 * bounds by the RRD list rather than by count. */
