...
# mount(8) as OpenBSD prints it. /net is nfs -- hard-blocking, so it goes behind
...
pass "xymonclient-openbsd.sh: the remote-df sentinel is wired to mount(8) and both reports -- OpenBSD mount output replayed, df stubbed"
